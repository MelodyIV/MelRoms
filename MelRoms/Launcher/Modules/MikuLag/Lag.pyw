...
class MelRomsLagSwitch:
    def __init__(self, root):
        ...
        # Cache for process names (avoid repeated psutil calls)
        self.pid_cache = {}
        self.pid_cache_time = {}
    ...
    def create_widgets(self):
        ...
        # Target Section with System‑wide toggle
        ...
        # Warning label for system‑wide mode
        ...
        self.warning_label.pack_forget()  # hidden initially
    ...
    def toggle_system_wide(self):
        """Enable/disable target entry based on system‑wide checkbox."""
        if self.system_wide.get():
            self.app_var.set("")  # clear target
            self.warning_label.pack(fill=tk.X, pady=(5, 0))
        else:
    ...
    def is_target_process(self, pid, target_name):
        """Return True if packet should be lagged."""
        if self.system_wide.get():
            return True   # lag everything
    ...
    def packet_handler(self, target_name):
        """Main packet processing loop – Fixed PID access."""
        ...
        try:
            with pydivert.WinDivert(filter_str) as w:
                ...
                while self.running:
                    ...
                    # --- THE FIX: Access pid through p.interface.pid ---
                    try:
                    ...
                    if is_target:
                        ...
                        if should_lag:
                            ...
                            if hold_sec > 0:
                                ...
                                # Quick threaded delay to keep the main loop fast
...
if __name__ == "__main__":
    # Elevate to Admin (required for WinDivert)

...
class MikuPinger:
    ...
    def create_widgets(self):
        ...
        # Header
        tk.Label(self.main_frame, text=ASCII_HEADER, font=("Courier New", 8, "bold"),
                 fg=MikuTheme.TEAL, bg=MikuTheme.DARK, justify=tk.LEFT).pack(pady=(0, 10))
        
        # --- Target Section ---
        target_frame = tk.LabelFrame(self.main_frame, text=" 🎯 TARGET CONFIG ", fg=MikuTheme.PINK,
                                    bg=MikuTheme.PANEL, font=("Arial", 10, "bold"), padx=10, pady=10)
        ...
        self.target_entry = tk.Entry(target_frame, textvariable=self.target_var,
                                     ...
                                     insertbackground=MikuTheme.TEXT_FG, font=("Consolas", 11), width=35)
        ...
        tk.Checkbutton(target_frame, text="🌐 Randomize IP", variable=self.random_check_var,
                       ...
                       font=("Arial", 9), command=self.toggle_random_mode).pack(side=tk.LEFT, padx=10)
        ...
        tk.Entry(msg_frame, textvariable=self.msg_var, bg=MikuTheme.TEXT_BG, fg=MikuTheme.TEXT_FG,
                 insertbackground=MikuTheme.TEXT_FG, font=("Arial", 10)).pack(fill=tk.X)
        ...
        self.start_btn = tk.Button(ctrl_frame, text="🎵 START SESSION", command=self.start_pinging,
                                   bg=MikuTheme.BTN_BG, fg=MikuTheme.BTN_FG, font=("Arial", 10, "bold"),
        ...
        out_frame = tk.LabelFrame(self.main_frame, text=" 📡 TRANSMISSION LOG ", fg=MikuTheme.TEAL,
                                  bg=MikuTheme.PANEL, font=("Arial", 10, "bold"))
        ...
        tk.Label(self.main_frame, textvariable=self.status_var, bg=MikuTheme.PANEL, fg=MikuTheme.TEAL,
                 anchor=tk.W, font=("Arial", 9), padx=10).pack(fill=tk.X, side=tk.BOTTOM, pady=(5,0))
    ...
    def ping_loop(self):
        ...
        while not self.stop_ping:
            ...
            # Sub-loop for responsive stopping
            for _ in range(10):

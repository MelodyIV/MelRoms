...
# Compact settings
FOV = 350
OFFSET_X = 350       # centered for 700px width
OFFSET_Y = 275       # centered for 550px height
GRID_SIZE = 30      # smaller cubes
GRID_WIDTH = 30
GRID_HEIGHT = 20
...
def main():
    pygame.init()
    pygame.display.set_caption("3D Wireframe Snake")
    ...
    while running:
        ...
        sway = math.sin(pygame.time.get_ticks() * 0.002) * 8
        # Draw background grid points

...
class ColorPickerApp:
    ...
    def _setup_ui(self):
        ...
        tk.Label(card, text="Click the button, then click anywhere on your screen",
                 font=("Segoe UI", 9), bg=BG_CARD, fg=TEXT_MUTED).pack(anchor="w", pady=(0, 10))
        ...
        preview_frame.pack(pady=25)
        self.preview_canvas = tk.Canvas(preview_frame, width=200, height=120,
        ...
        copy_hex_btn = tk.Button(btn_frame, text="📋 COPY HEX",
                                 ...
                                 relief="flat", bd=0, highlightthickness=0,
                                 padx=12, pady=6)
        copy_hex_btn.pack(side="left", padx=(0, 10))
        ...
        status = tk.Label(main, textvariable=self.status_var,
                          font=("Consolas", 9), bg=BG_DARK, fg=TEXT_MUTED)
        status.pack(pady=(10, 0))
        self._update_display()
    def _create_slider(self, parent, label, var, color):
        frame = tk.Frame(parent, bg=BG_CARD)
        frame.pack(fill="x", pady=5)
        lbl = tk.Label(frame, text=label, font=("Consolas", 11, "bold"),
        ...
        scale = tk.Scale(frame, from_=0, to=255, orient="horizontal",
                         ...
                         length=280, borderwidth=0)
        scale.pack(side="left", fill="x", expand=True)
        val_label = tk.Label(frame, textvariable=var, font=("Consolas", 9),
